...
function UpdateNurse(){
    ...
    useEffect(() => {
        ...
        setData({nurseId:nur.nurseId,firstName:nur.firstName,lastName:nur.lastName,
            gender:nur.gender,dob:nur.dob,graduation:nur.graduation,postGraduation:nur.postGraduation,
            speciality:nur.speciality,fees:nur.fees,mobileNumber:nur.mobileNumber,areaId:nur.area_id,loginId:nur.login_id})
             setState(nur.area_id.city_id.state_id.stateName);
             setCity(nur.area_id.city_id.cityName);
             setArea(nur.area_id.areaName);
            //getState();
    ...
    if(fees === ""){
      ...
      const submitData=(e)=>{
        ...
        if(flag.firstName&&flag.lastName&&flag.mobileNumber&&flag.speciality&&flag.fees){
                ...
                fetch("http://localhost:8080/updatenurse",reqOptions)
                .then(resp=>resp.text())
        ...
        <h2 className='text-center'>Update Information </h2>
         ...
         <form method="POST">
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="text"  name="firstName" className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="text" placeholder={data.lastName} name="lastName" className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="text" placeholder={data.mobileNumber} name="mobileNumber" className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
          ...
          <div style={{ marginTop: '10px' }} className = "form-group">
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="text" placeholder={data.speciality} name="speciality"  className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="text" placeholder={data.fees} name="fees" className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
...
*/}</form>
            ...
            <div className="offset-4" style={{marginTop: "10px"}}>
