        ...
        <div className="container" style={{marginBottom : "50px"}}>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-4">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">View Nurse List</h5>
                                <p className="card-text">View details of all registered nurses.</p>
                                <button onClick={() => navigate("/viewnurse")} className="btn btn-warning">VIEW</button>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-4">
                ...
                <div className="col-sm-4">
                    ...
                    <div className="col-sm-4">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">Add New Nurse</h5>
                                <p className="card-text">Register a new nurse to database.</p>
                                <button onClick={() => navigate("/addnurse")} className="btn btn-primary">ADD</button>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-4">
