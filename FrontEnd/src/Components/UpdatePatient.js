...
function UpdatePatient(){
    ...
    <div className = "row">
        <div className = "card col-md-6 offset-md-3 offset-md-3 bg-transparent border-0 text-light">
        <h2 className='text-center'>Update Information </h2>
         ...
         <form method="POST">
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="text" placeholder={data.firstName} name="firstName" className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="date" placeholder={data.dob} name="dob" className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
                    value={data.dob} onChange={changeHandler} />
            </div >

            <div style={{ marginTop: '10px' }} className = "form-group">
                <label><b>  Blood Group: </b></label>
                <input type="text" placeholder={data.blood_group} name="graduation" className="form-control bg-transparent text-light  border-0 border-bottom border-primary" 
