                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            ...
                            <div className="d-flex flex-column justify-content-center align-items-center w-100 h-100 position-fixed slideContent">
                                <h4 className="text-light font-weight-bolder text-uppercase">A great place to work. A great place to receive care.</h4>
                                <div className="container w-50">
                                    <p className="display-6 text-light text-center">Open to everyone everyday and provides primary healthcare services at desired locations on just a click.</p>
                                </div>
                                <div>
